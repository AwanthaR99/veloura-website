  ...
  return (
    <div className="bg-black text-white pt-32 pb-20 px-4 md:px-10">
      <div className="container mx-auto text-center">
        <h1 className="text-6xl font-serif mb-4 text-yellow-400">Get In Touch</h1>
        <p className="text-lg text-gray-400 mb-16 max-w-2xl mx-auto">We would love to hear from you. For reservations, please use our booking page.</p>
        ...
        <div className="mt-20">
           ...
           <div className="overflow-hidden rounded-lg border-2 border-gray-800">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31682.81249911993!2d81.3321526017308!3d6.882196025139828!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae47e5b65e86b25%3A0x7c26883272d24276!2sMonaragala!5e0!3m2!1sen!2slk!4v1722276587373!5m2!1sen!2slk" 
                width="100%" 
                height="450" 
                style={{ border: 0 }} 
                allowFullScreen="" 
